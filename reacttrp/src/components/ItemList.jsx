...
const juegos =[
    ...
    {nombre:"Rainbox Six",precio:100,genero:"fps",id:4,urlImg:"https://www.egames.news/__export/1613975597884/sites/debate/img/2021/02/21/cuxnto_pesa_rainbow_sixx_requisitos_mxnimos_y_recomendados.jfif_242310155.jfif"},
    {nombre:"World of Warcraft",precio:500,genero:"mmorpg",id:5,urlImg:"https://depor.com/resizer/VmbW0YqgmwndDxau1aD_RVGeB2c=/580x330/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/HFTKHCX2AFFHNOWW3ANTZY7TOU.jpg"},
    ...
    {nombre:"Need for Speed",precio:200,genero:"carreras",id:7,urlImg:"https://img.youtube.com/vi/9ewiJJe_nYI/maxresdefault.jpg"},
    {nombre:"Counter Strike",precio:80,genero:"fps",id:8,urlImg:"https://rkesport.com/wp-content/uploads/2020/11/cs-go-Counter-Strike-Global-Offensive-page-portada-883x494.jpg"},
        ...
        return (
            ...
            {juegos.map((value) => {
                return (
                    ...
                    <Item style={{styles}} item={value}></Item>
